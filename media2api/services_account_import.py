...
STRUCTURED_CREDENTIAL_KEYS = (
    ...
    "qwen_ai_cookie_or_session",
    "qianwen_cookie_or_session",
    "codex_account_export",
    "chatgpt_cookie_or_session",
    "gemini_web_cookie_or_session",
    "antigravity_profile",
    "jimeng_cookie_or_session",
    "doubao_cookie_or_session",
    "kling_cookie_or_session",
    "luma_cookie_or_session",
    "api_key",
    "apiKey",
    "LUMA_API_KEY",
    "luma_api_key",
