...
request checklists, runtime delivery plans, release probe matrices, loopback
runtime contract matrices, loopback contract self-tests, go-live checklists,
process status, and stdout/stderr log inspection. The `/admin` dashboard has a
