...
def main() -> None:
    ...
    try:
      with TestClient(app) as client:
        ...
        for activation_dom in ["kernel-activation-workflow-all", "kernel-activation-workflow", "kernel-activation-overview", "kernel-activation-panel", "activation-stage-grid", "activation-provider-grid", "renderActivationWorkflowPanel", "renderActivationWorkflowOverview", "/v1/admin/proxy-kernels/activation-workflow", "/activation-workflow"]:
