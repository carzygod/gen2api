...
def main() -> None:
    ...
    try:
      with TestClient(app) as client:
        ...
        for account_material_dom in ["kernel-account-materials", "kernel-account-materials-matrix", "kernel-account-connection-package", "kernel-production-unblock-package", "kernel-account-material-panel", "kernel-account-credential", "kernel-account-resource-profile", "kernel-account-preflight", "kernel-account-import", "kernel-account-runtime-sync", "kernel-account-runtime-sync-status", "submitKernelAccountMaterials", "syncKernelRuntimeCredentials", "renderKernelAccountMaterialsPanel", "loadKernelAccountMaterials", "renderKernelAccountMaterialsMatrix", "loadKernelAccountMaterialsMatrix", "renderKernelAccountConnectionPackage", "loadKernelAccountConnectionPackage", "renderProductionUnblockPackage", "loadProductionUnblockPackage", "resource_profile_json_template", "fields_by_destination", "/account-materials", "/account-materials-matrix", "/account-connection-package", "/production-unblock-package", "/account-materials-bulk", "/runtime-credentials/sync"]:
