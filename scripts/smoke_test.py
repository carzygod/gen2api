...
def main() -> None:
    ...
    try:
      with TestClient(app) as client:
        ...
        assert "node" in source_runtime_plan["detected_project_types"] and source_runtime_plan["preferred_start_command"]["command"][:3] == ["npm", "run", "start"], source_runtime_plan
